    ...
    <head>
        ...
        <link rel="shortcut icon" href="theme/assets/compiled/svg/logo.svg" type="image/x-icon" />
    ...
    <body>
        <script src="theme/assets/static/js/initTheme.js"></script>
        <div id="app">
            <div id="sidebar">
                <div class="sidebar-wrapper active">
                    <div class="sidebar-header position-relative">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="theme/assets/compiled/svg/logo.svg" alt="Logo"
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="dropdown">
                                <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="user-menu d-flex">
                                        <div class="user-name text-end me-3">
                                            <h6 class="mb-0 text-gray-600">{{ session('nama_pengguna') }}</h6>
                                            <p class="mb-0 text-sm text-gray-600">{{ session('role') }}</p>
                                        </div>
                                        <div class="user-img d-flex align-items-center">
                                            <div class="avatar avatar-md">
                                                <img src="{{ session('foto') }}" />
                                                <!-- Assuming 'foto_pengguna' is the session key for the user's photo -->
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"
                                    ...
                                    <li>
                                        <h6 class="dropdown-header">Hello, {{ session('nama_pengguna') }}!</h6>
                                    </li>
                                    <li>
